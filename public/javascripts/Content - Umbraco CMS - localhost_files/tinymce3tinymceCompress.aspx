var tinyMCEPreInit = {base : '/umbraco_client/tinymce3', suffix : '_src'};// FILE IS GENERATED BY COMBINING THE SOURCES IN THE "classes" DIRECTORY SO DON'T MODIFY THIS FILE DIRECTLY
(function(win) {
...
toolbar:"Toolbar"});
tinymce.ThemeManager.urls['umbraco'] = tinymce.baseURL+'/themes/umbraco';/**
...
tinymce.ThemeManager.urls['contextmenu'] = tinymce.baseURL+'/plugins/contextmenu';/**
...
tinymce.ThemeManager.urls['umbracomacro'] = tinymce.baseURL+'/plugins/umbracomacro';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
});tinymce.ThemeManager.urls['umbracoembed'] = tinymce.baseURL+'/plugins/umbracoembed';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
})();tinymce.ThemeManager.urls['noneditable'] = tinymce.baseURL+'/plugins/noneditable';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
tinymce.ThemeManager.urls['inlinepopups'] = tinymce.baseURL+'/plugins/inlinepopups';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
tinymce.ThemeManager.urls['table'] = tinymce.baseURL+'/plugins/table';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
})();tinymce.ThemeManager.urls['advlink'] = tinymce.baseURL+'/plugins/advlink';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
tinymce.ThemeManager.urls['paste'] = tinymce.baseURL+'/plugins/paste';/**
 * editor_plugin_src.js
 *
 * Copyright 2009, Moxiecode Systems AB
 * Released under LGPL License.
...
tinymce.ThemeManager.urls['spellchecker'] = tinymce.baseURL+'/plugins/spellchecker';/**
...
})();tinymce.ThemeManager.urls['umbracoimg'] = tinymce.baseURL+'/plugins/umbracoimg';/**
* $Id: editor_plugin_src.js 201 2007-02-12 15:56:56Z spocke $
*
* @author Moxiecode
* @copyright Copyright © 2004-2008, Moxiecode Systems AB, All rights reserved.
...
tinymce.ThemeManager.urls['umbracocss'] = tinymce.baseURL+'/plugins/umbracocss';ï»¿/**
* editor_plugin_src.js
*
...
tinymce.ThemeManager.urls['umbracopaste'] = tinymce.baseURL+'/plugins/umbracopaste';ï»¿/**
* editor_plugin_src.js
*
* Copyright 2012, Umbraco
* Released under MIT License.
...
tinymce.ThemeManager.urls['umbracolink'] = tinymce.baseURL+'/plugins/umbracolink';ï»¿/**
* editor_plugin_src.js
*
* Copyright 2012, Umbraco
* Released under MIT License.
...
tinymce.ThemeManager.urls['umbracocontextmenu'] = tinymce.baseURL+'/plugins/umbracocontextmenu';if (typeof (Sys) !== 'undefined') {
